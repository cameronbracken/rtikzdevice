...
\subsubsection{Plotmath vs. tikzDevice output with UTF-8 Characters}
<<plotmath,echo=T,results=hide,keep.source=T>>=

pdf("plotmath.pdf",width=4,height=4)
options(tikzLatexPackages=getOption('tikzXelatexPackages'))

dev.off()

#Same using tikz
tikz("plotmath.tex",width=4,height=4)
